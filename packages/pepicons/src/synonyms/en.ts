...
export const synonyms: { [name in Pepicon]: string[] } = {
  ...
  'bell-off': ['no-notification', 'no-attention', 'quiet', 'silent'],
  'bicycle': ['bike'],
  'bluetooth': [],
  'book': ['read', 'bookmark'],
  'bookmark': ['flag', 'clip'],
  ...
  'exclamation': ['bang', 'exclamation-mark', 'exclamation-point', 'shriek', 'pling', 'note-of-admiration', 'warning', 'danger'],
  'exclamation-filled': ['bang', 'exclamation-mark', 'exclamation-point', 'shriek', 'pling', 'note-of-admiration', 'warning', 'danger'],
